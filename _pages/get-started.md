...
## Создание бэкапа NAND с использованием приложения Flipnote Studio (старый способ, пока пускай тоже будет)
...
2. Включите консоль и повторите все шаги 1 и 2 (для способа с камерой) или с 1 по 12 (для способа с Flipnote) из раздела "Создание бэкапа NAND"
