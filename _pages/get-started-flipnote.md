...
## Что понадобится 
- [SD-card files](files/flip/SD-card.zip)
...
- Наглядная видео-инструкция с 1 по 12 пункты для владельцев [JAP](files/flip/jap.mp4){:target="_blank"} и [USA/EUR](files/flip/ue.mp4){:target="_blank"} консолей 
