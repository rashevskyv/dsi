...
header:	
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по прошивке Nintendo DSi<br />**Последнее изменение:** 22 августа 2019'
---
...
- Модификация происходит используя Memory Pit - наиболее простой и удобный эксплоит приложения Камера DSi, подходящей консолей всех регионов на любых версиях ПО.
