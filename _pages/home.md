...
header:	
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по прошивке Nintendo DSi<br />**Последнее изменение:** 28 мая 2019'
---
...
- Модификация происходит через встроенное приложение **Камера DSi**. Альтернативные способы - использование **Flipnote studio** (уже должно иметься на консоди)и [хардмод](hardmode){:target="_blank"} (Процесс ёмкий и давольно сложный. Необходимо иметь опыт в пайке, не особо актуален на данный момент).
